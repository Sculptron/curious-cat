...
import type { PredictCard, SemanticTheme } from '../../types/journey'
...
//
// Uses the theme's "interact" illustration variant (never "hero" — that's
// the concept card's and mint card's job) as a top banner, same bottom-fade
// bleed treatment as ConceptCardView. Shorter than the concept card's banner
// since this screen also needs room for 2-3 crates plus the reveal panel.
export default function PredictCardView({
  card,
  theme,
  onAnswered,
}: {
  ...
  return (
    <div className="flex flex-col">
      <ThemeIllustration theme={theme} variant="interact" heightClassName="h-[20vh]" />
